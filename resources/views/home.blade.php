@extends('main')
@section('content')
<section class="engine"><a rel="external" href="https://mobirise.com">html5 site builder</a></section><section class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--full-height mbr-section--bg-adapted mbr-parallax-background" id="header4-7" style="background-image: url(assets/images/grid-book-3000x2000-47.jpg);">
            ...
            <div class="mbr-box mbr-box--stretched"><div class="mbr-box__magnet mbr-box__magnet--center-center">
                <div class="row"><div class=" col-sm-8 col-sm-offset-2">
                    <div class="mbr-hero animated fadeInUp">
                        <h3 class="mbr-hero__text"><p>非常easy的创建一个好用的CMS</p></h3>
                        <p class="mbr-hero__subtext">这是一个基于Laravel简单实用的CMS系统</p>
                    </div>
                    <div class="mbr-buttons btn-inverse mbr-buttons--center"><a class="mbr-buttons__btn btn btn-lg btn-danger animated fadeInUp delay" href="https://mobirise.com">Start</a> <a class="mbr-buttons__btn btn btn-lg btn-default animated fadeInUp delay" href="https://mobirise.com">了解更多</a></div>
                </div></div>
            </div></div>
        </div>
        <div class="mbr-arrow mbr-arrow--floating text-center">
            <div class="mbr-section__container container">
                <a class="mbr-arrow__link" href="#features1-9"><i class="glyphicon glyphicon-menu-down"></i></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="mbr-section__container container mbr-section__container--std-top-padding" style="padding-top: 93px;">
        <div class="mbr-section__row row">
            ...
            <div class="mbr-section__col col-xs-12 col-lg-2-4 col-md-4 col-sm-6">
                ...
                <div class="mbr-section__container mbr-section__container--last" style="padding-bottom: 93px;">
                    <div class="mbr-buttons mbr-buttons--center"><a href="https://baidu.com" class="mbr-buttons__btn btn btn-wrap btn-xs-lg btn-default" target="_blank">LEARN MORE</a></div>
                </div>
            </div>
...
<section class="mbr-gallery mbr-section mbr-section--no-padding" id="gallery1-8" style="background-color: rgb(76, 105, 114);">
    <!-- Gallery -->
        ...
        <div>
            <div class="row mbr-gallery-row no-gutter">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mbr-gallery-item">
                    ...
                    <a href="#lb-gallery1-8" data-slide-to="0" data-toggle="modal">
                    ...
                    <a href="#lb-gallery1-8" data-slide-to="1" data-toggle="modal">
                    ...
                    <a href="#lb-gallery1-8" data-slide-to="2" data-toggle="modal">
                    ...
                    <a href="#lb-gallery1-8" data-slide-to="3" data-toggle="modal">
                    ...
                    <a href="#lb-gallery1-8" data-slide-to="4" data-toggle="modal">
                    ...
                    <a href="#lb-gallery1-8" data-slide-to="5" data-toggle="modal">
                    ...
                    <a href="#lb-gallery1-8" data-slide-to="6" data-toggle="modal">
                    ...
                    <a href="#lb-gallery1-8" data-slide-to="7" data-toggle="modal">
...
<section class="mbr-section mbr-section--relative mbr-section--fixed-size mbr-parallax-background" id="content5-10" style="background-image: url(assets/images/bg3.jpg);">
...
<section class="mbr-section mbr-section--relative mbr-section--fixed-size" id="testimonials1-11" style="background-color: rgb(255, 255, 255);">
    <div>
